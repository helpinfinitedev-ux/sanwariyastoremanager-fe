...
import { View, Text, StyleSheet, ScrollView, ActivityIndicator, TouchableOpacity, useWindowDimensions } from '@/web/primitives';
import { useNavigation } from '@/web/navigation';
import { DrawerNavigationProp } from '@/web/navigation';
